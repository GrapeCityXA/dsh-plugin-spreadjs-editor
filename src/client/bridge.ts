 ...
 * offers the document to `dsh-spreadjs-excel`'s `spreadjsHostBridge` service and
 ...
 *
 * The bridge is optional. With dsh-spreadjs-excel absent, or with a bridge that
...
/** The `spreadjsHostBridge` client service published by dsh-spreadjs-excel. */
export interface SpreadjsHostBridge {
  attach(provider: SpreadjsWorkbookProvider): () => void
  list?(): readonly string[]
}

/** Service name owned by dsh-spreadjs-excel; this file only names it. */
